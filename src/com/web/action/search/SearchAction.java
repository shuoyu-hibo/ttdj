...
public class SearchAction extends BaseAction {
	...
	public void search() throws Exception {
		...
		String ct = commonUtil.decodeUrl(request.getParameter("ct"));
		...
		pagePojo.setCityCode(Integer.parseInt("".equals(ct)?"0":ct));
	...
	public void getProduceInfoById() throws Exception {
		...
		CommonToolServiceImpl commonToolServiceImpl = ((CommonToolServiceImpl) getApplicationContext().getBean("commonToolServiceImpl"));
		Map<String,String> resultMap = commonToolServiceImpl.selectProduceById(produceId);
		JsonUtil jsUtil = new JsonUtil();
		JSONArray jsAry=new JSONArray();
		if(resultMap!=null){
			jsAry.add(resultMap);
